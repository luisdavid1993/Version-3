    ...
    public partial class registrar : System.Web.UI.Page
    {
        ...
        protected void LinkButtonSaveAccount_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                //if (resellerID == 0)
                //{
                //    streamingcpanel.Objects.ClassEmailSended.emailNewUser(resellerID.ToString(), myUser.User_USerLogin.Trim(), myUser.User_name.Trim(), myUser.User_USerEmail, myUser.User_UserPassword); 
                //}
                //else
                //{
                //    streamingcpanel.Objects.ClassEmailSended.emailNewUser(resellerID.ToString(), myUser.User_USerLogin.Trim(), myUser.User_name.Trim(), "", myUser.User_UserPassword);
                //}                

                Response.Redirect("newConfirmacion.aspx", true);
